import { closeAdminJob, deleteAdminJob, fetchAdminDashboard, fetchAdminJob, fetchAdminJobs, fetchAllApplications, fetchAllUsers, fetchJobCandidates, fetchTeamMembers, updateAdminJob } from "@/api/admin"
