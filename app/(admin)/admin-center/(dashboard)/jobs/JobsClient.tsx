        ...
        <>
            ...
            <div className="w-full my-4 ring-1 ring-gray-300 rounded shadow p-2 bg-white">
                <div className="rounded bg-gray-100 relative">
                    ...
                    <label className="sr-only" htmlFor="admin-job-search">Search jobs</label>
                    <input id="admin-job-search" type="search" className="rounded ring-1 ring-gray-300 px-10 py-2 w-full" placeholder="Search jobs…" />
                </div>
            </div>
