      ...
      cell: ({ row }: { row: Row<Application> }) => (
        <div className="relative">
          <button
            ...
            aria-controls={`application-actions-${row.id}`}
          ...
          {openMenuId === row.id && (
            <div id={`application-actions-${row.id}`} className="absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded shadow-md z-10">
              <button
                type="button"
